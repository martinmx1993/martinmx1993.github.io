jQuery("#simulation")
  .on("click", ".s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/05bbb449-2fed-4f2e-b54e-71ef0ca0d399"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad #s-Panel_1": {
                      "attributes": {
                    ...
                    "#s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad #s-Panel_1 .verticalalign": {
                      "attributes": {
                        "vertical-align": "top"
                      }
                    }
  ...
  .on("mouseenter dragenter", ".s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad #s-Label_55": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad #s-Label_56": {
                      "attributes": {
                        "background-color": "#AA0719",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad #s-Rectangle_13": {
                      "attributes": {
                        "background-color": "#AA0719",
                        "background-image": "none"
                      }
  ...
  .on("mouseleave dragleave", ".s-717f4c1d-6afd-4b0e-b55a-8fc9487b5bad .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
