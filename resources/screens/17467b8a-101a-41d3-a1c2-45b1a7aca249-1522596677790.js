jQuery("#simulation")
  .on("click", ".s-17467b8a-101a-41d3-a1c2-45b1a7aca249 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/0fec13cc-5eac-49aa-b9a8-59d31ecedacb"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/3e41fe23-8b68-4865-98c3-3e9d8bb39f92"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("pageload", ".s-17467b8a-101a-41d3-a1c2-45b1a7aca249 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-tick_1")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("mouseenter dragenter", ".s-17467b8a-101a-41d3-a1c2-45b1a7aca249 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-17467b8a-101a-41d3-a1c2-45b1a7aca249 #s-Label_55": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-17467b8a-101a-41d3-a1c2-45b1a7aca249 #s-Rectangle_3": {
                      "attributes": {
                        "background-color": "#AA0719",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-17467b8a-101a-41d3-a1c2-45b1a7aca249 #s-Rectangle_10": {
                      "attributes": {
                        "background-color": "#AA0719",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-17467b8a-101a-41d3-a1c2-45b1a7aca249 #s-Rectangle_4": {
                      "attributes": {
                        "background-color": "#AA0719",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-17467b8a-101a-41d3-a1c2-45b1a7aca249 #s-Label_56": {
                      "attributes": {
                        "background-color": "#AA0719",
                        "background-image": "none"
                      }
  ...
  .on("mouseleave dragleave", ".s-17467b8a-101a-41d3-a1c2-45b1a7aca249 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
