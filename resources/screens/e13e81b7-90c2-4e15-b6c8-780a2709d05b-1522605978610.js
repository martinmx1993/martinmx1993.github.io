jQuery("#simulation")
  .on("click", ".s-e13e81b7-90c2-4e15-b6c8-780a2709d05b .click", function(event, data) {
  ...
  .on("pageload", ".s-e13e81b7-90c2-4e15-b6c8-780a2709d05b .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseenter dragenter", ".s-e13e81b7-90c2-4e15-b6c8-780a2709d05b .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-e13e81b7-90c2-4e15-b6c8-780a2709d05b #s-Rectangle_3": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-e13e81b7-90c2-4e15-b6c8-780a2709d05b #s-Rectangle_10": {
                      "attributes": {
                        "background-color": "#AA0719",
                        "background-image": "none"
                      }
  ...
  .on("mouseleave dragleave", ".s-e13e81b7-90c2-4e15-b6c8-780a2709d05b .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
